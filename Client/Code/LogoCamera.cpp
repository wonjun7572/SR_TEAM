...
void CLogoCamera::Save_Position()
{
...
void CLogoCamera::Load_Position()
{
	if (m_liPos.empty())
		return;
...
void CLogoCamera::Key_Input(const _float& fTimeDelta)
{
	_matrix		matCamWorld;
...
void CLogoCamera::Mouse_Move(void)
{
	_matrix		matCamWorld;
	D3DXMatrixInverse(&matCamWorld, nullptr, &m_matView);
...
void CLogoCamera::Mouse_Fix(void)
{
