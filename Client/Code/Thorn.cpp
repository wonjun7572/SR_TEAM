...
HRESULT CThorn::Ready_Object(const _vec3 & vPos, _tchar* Name)
{
...
_int CThorn::Update_Object(const _float & fTimeDelta)
{
	...
	if (m_bFirst)
	{
		...
		Load_Animation(L"../../Data/Thorn/TRAP_1_UP.dat", 0);
		Load_Animation(L"../../Data/Thorn/TRAP_1_DOWN.dat", 1);
	}
...
void CThorn::LateUpdate_Object(void)
{
...
{
	HANDLE      hFile = CreateFile(L"../../Data/Thorn/TRAP_1.dat",      // 파일의 경로와 이름	
...
void CThorn::Load_Animation(wstring FileName, _uint AnimationID)
{
...
void CThorn::Run_Animation(const _float & AnimationSpeed)
{
...
void CThorn::Up_Animation_Run(void)
{
	list<pair<const _tchar*, CGameObject*>> ListBox = *(pMyLayer->Get_GamePairPtr());
...
void CThorn::Down_Animation_Run(void)
{
	list<pair<const _tchar*, CGameObject*>> ListBox = *(pMyLayer->Get_GamePairPtr());
...
CThorn * CThorn::Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3 & vPos, _tchar * Name)
{
