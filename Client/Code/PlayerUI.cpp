...
void CPlayerUI::Begin_OrthoProj()
{
	...
	matView.m[0][0] = 169.f; // 이미지 가로
	matView.m[1][1] = 89.f; // 이미지 세로
	matView.m[2][2] = 1.f;
	matView.m[3][0] = m_pTransCom->m_vInfo[INFO_POS].x - 230.f;
	matView.m[3][1] = m_pTransCom->m_vInfo[INFO_POS].y - 220.f;
