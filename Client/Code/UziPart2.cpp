#include "stdafx.h"
#include "..\Header\UziPart2.h"


CUziPart2::CUziPart2(LPDIRECT3DDEVICE9 pGraphicDev)
	:CWeapon(pGraphicDev)
{
}
...
HRESULT CUziPart2::Ready_Object(void)
{
	...
	m_pTransform->Set_Scale(.2f, .2f, 1.2f);

	return S_OK;
}

_int CUziPart2::Update_Object(const _float & fTimeDelta)
{
...
void CUziPart2::LateUpdate_Object(void)
{
...
HRESULT CUziPart2::Add_Component(void)
{
...
CUziPart2 * CUziPart2::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CUziPart2* pInstance = new CUziPart2(pGraphicDev);
