...
//	attribute->vPos = m_vCubePatriclePos + attribute->vVelocity / 2.5f;
...
D3DXVec3Normalize(&attribute->vVelocity, &attribute->vVelocity);
D3DXVec3Normalize(&m_vDir, &m_vDir);
attribute->vPos = m_vCubePatriclePos + attribute->vVelocity / 5.f;
attribute->vPos += m_vDir*1.5f;
attribute->vPos.y -= attribute->vVelocity.y / .15f;
attribute->dwColor = D3DXCOLOR(1.f, 1.f, 1.f, 1.f);
attribute->fAge = 0.0f;
attribute->fLifeTime = .5f;
}
