...
namespace Engine
{
	...
	enum KRAKENSTATEID { KRAKEN_IDLE, KRAKEN_WALK, KRAKEN_ATTACK, KRAKENSTATE_END };

	enum KRAKENIDLEID { KRAKENIDLE_1, KRAKENIDLE_2, KRAKENIDLE_3, KRAKENIDLE_4, KRAKENIDLE_END };

	enum KRAKENSMASHID { KRAKENSMASH_1, KRAKENSMASH_2, KRAKENSMASH_3, KRAKENSMASH_4, KRAKENATTACK_END };
	...
	enum KRAKENLURKERID {KRAKENLURKER_1, KRAKENLURKER_2, KRAKENLURKER_3, KRAKENLURKER_4 };

	enum KRAKENSKILLID { KRAKEN_SKILL_SMASH, KRAKEN_SKILL_INKSHOT, KRAKEN_SKILL_3, KRAKEN_SKILL_4, KRAKEN_SKILL_5 };
