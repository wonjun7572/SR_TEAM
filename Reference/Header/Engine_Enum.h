...
// ID_STATIC : 한 번 만들면 그대로 사용할 컴포넌트 집단
	...
	enum KRAKENWALKID { KRAKENWALK_START, KRAKENWALK_1, KRAKENWALK_2, KRAKENWALK_3, KRAKENWALK_END };
	enum KRAKENIDLEID { KRAKENIDLE_1, KRAKENIDLE_2, KRAKENIDLE_3, KRAKENIDLE_END };
	enum KRAKENATTACKID { KRAKENATTACK_START, KRAKENATTACK_1, KRAKENATTACK_2, KRAKENATTACK_3, KRAKENATTACK_END };
	enum KRAKENSHOTID { KRAKENSHOT_START, KRAKENSHOT_1, KRAKENSHOT_2, KRAKENSHOT_3, KRAKENSHOT_END };
	enum KRAKENCRASHID {KRAKENCRASH_1, KRAKENCRASH_2, KRAKENCRASH_3, KRAKENCRASH_END};
